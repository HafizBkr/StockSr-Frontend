...
export default function Sidebar({ className = "" }: { className?: string }) {
  ...
  const baseMenu = [
    ...
    { label: "Produits", icon: PackageSearch, href: "/admin/products" },
    { label: "Catégories", icon: Tag, href: "/admin/categories" },
    { label: "Fournisseurs", icon: Truck, href: "/admin/fournisseurs" },
    { label: "Ventes", icon: BarChart3, href: "/admin/sales/list" },
    {
