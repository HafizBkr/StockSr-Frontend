...
import type { Produit, ProduitUpdate } from "../../../../models/produit";
...
interface EditProductModalProps {
  ...
  onSuccess?: (data: ProduitUpdate) => void;
}
...
export default function EditProductModal({
  ...
  const [formData, setFormData] = useState<ProduitUpdate>({
    nom: "",
    prix_achat: 0,
    prix_vente: 0,
    unite: "",
  ...
  const validateForm = () => {
    ...
    if (formData.prix_achat === undefined || formData.prix_achat <= 0)
    ...
    if (
      formData.prix_vente !== undefined &&
      formData.prix_achat !== undefined &&
      formData.prix_vente <= formData.prix_achat
    )
      newErrors.prix_vente =
        "Le prix de vente doit être supérieur au prix d'achat";
    if (formData.quantite_stock === undefined || formData.quantite_stock < 0)
      newErrors.quantite_stock = "Le stock doit être positif";
    if (formData.seuil_alerte === undefined || formData.seuil_alerte < 0)
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-md bg-black/20 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white rounded-xl max-w-2xl w-full max-h-[85vh] flex flex-col overflow-hidden relative shadow-xl">
        {/* Header */}
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-600">
                Ajustez les informations du produit
              </p>
            </div>
          </div>
          <button
          ...
          >
            ...
            <div className="flex justify-end gap-3 pt-6 border-t border-zinc-200">
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 text-sm font-medium transition-colors disabled:opacity-50 flex items-center gap-2"
              >
                <Save size={18} />
